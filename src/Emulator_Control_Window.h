...
#ifdef SPICE_DISPLAY
#include "Embedded_Display/SpiceView.h"
#endif
#endif
...
class Emulator_Control_Window: public QMainWindow
{
	...
	private:
		...
		#ifdef VNC_DISPLAY
		MachineView *Machine_View = nullptr;
		#ifdef SPICE_DISPLAY
		SpiceView *Spice_View = nullptr;
		#endif
		#endif
		...
		void Apply_Device_Changer_Menu();
		void Save_Emulator_Geometry();
		void Restore_Emulator_Geometry();
		bool Usb_Menus_Enabled() const;
